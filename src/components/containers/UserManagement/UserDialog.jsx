...
import {
  ...
  InputLabel,
  InputAdornment,
  IconButton, Grid, withStyles, MenuItem
...
class CreateUser extends PureComponent {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.id && this.props.id !== prevProps.id && localStorage.adminToken) {
      this.props.getUserInfo(localStorage.adminToken, this.props.id);
      this.props.getUserAssociateGroups(localStorage.adminToken, this.props.id);
    }
  ...
  onSaveClick = () => {
    ...
    if (!this.props.isEdit) {
      ...
      if (userEditData) {
        this.props.updateUser(localStorage.adminToken, this.props.id, userEditData);
      }
    }
    this.onHandleCancel();
  };
        ...
        >
          ...
          <DialogContent >
            ...
            <Grid container spacing={3} className={classes.container}>
              ...
              {!this.state.isEdit &&
                <Grid item xs={4}>
                  <FormControl required className={classes.temporaryPasswordForm}>
