...
class AddGroup extends PureComponent {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.admin && JSON.stringify(prevProps.admin) !== JSON.stringify(this.props.admin)) {
  ...
  onSaveClick = () => {
    if (this.state.add) {
      ...
      this.props.getKeycloakGroups(localStorage.adminToken);
    } else {
  ...
  render() {
    ...
    const { country, state, selectedChipTerminal, selectedChipGroupList } = this.state;
            ...
            <Grid container spacing={3} className={classes.gridRowStyle}>
              ...
              <Grid item xs={4} className={classes.groupFormGridCountry}>
                ...
                <CountryDropdown
                  ...
                  id="standard-basic"
                  defaultOptionLabel={I18n.t("GROUP.COUNTRY")}
                  value={country}
              ...
              <Grid item xs={4} className={classes.groupFormGridState}>
                ...
                <RegionDropdown
                  className={classes.countryStyle}
                  id="standard-basic"
                  blankOptionLabel={I18n.t("GROUP.STATE")}
                  type="text"
                  name="state"
                  country={country}
                  value={state}
